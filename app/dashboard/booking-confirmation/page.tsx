...
import { Check, Calendar, MapPin, Loader2, ImageIcon, Server, GitBranch } from "lucide-react"
                ...
                <div className="space-y-4">
                  ...
                  {bookingImages.length > 1 && (
                    <div className="grid grid-cols-6 gap-2">
                      {bookingImages.map((image: string, index: any) => (
                        <div
                          key={index}
                          className={`relative aspect-w-1 aspect-h-1 rounded-md overflow-hidden cursor-pointer ${activeImageIndex === index ? 'ring-2 ring-green-500' : ''
                            }`}
...
// Main export that wraps the client component with Suspense
