...
interface RescheduleDetailsDialogProps {
  isOpen: boolean
...
export function RescheduleDetailsDialog({
  isOpen,
  setIsOpen,
  request,
  onApprove,
  onReject
}: RescheduleDetailsDialogProps) {
      ...
      <DialogContent className="w-[95%] max-w-[700px] max-h-[90vh] overflow-y-auto p-4 sm:p-6 md:p-8">
        <DialogHeader>
          <DialogTitle className="flex flex-col sm:flex-row items-center justify-between gap-2">
            <span>Reschedule Request Details</span>
        ...
        <div className="space-y-6 my-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {request.original_time || "Time not available"}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border border-green-200 bg-green-50 rounded-md p-4">
              <h3 className="text-sm font-medium text-green-700 mb-2">Requested Change</h3>
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-600">
                    {request.requested_time || "Time not available"}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-2 border rounded-md p-4">
            <h3 className="text-sm font-medium text-gray-500 mb-2">Customer's Reason</h3>
